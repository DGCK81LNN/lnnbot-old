...
export interface NewFriendRequestEvent extends BaseRequestEvent {
     ...
     */
    message: string;
    respond: (operate: NewFriendRequestOperationType, message?: string) => Promise<void>;
}
/**
 * 用户入群申请（Bot需要有管理员权限）
 */
export interface MemberJoinRequestEvent extends BaseRequestEvent {
     ...
     */
    message: string;
    respond: (operate: MemberJoinRequestOperationType, message?: string) => Promise<void>;
}
/**
 * Bot被邀请入群申请
 */
export interface BotInvitedJoinGroupRequestEvent extends BaseRequestEvent {
     ...
     */
    message: string;
    respond: (operate: BotInvitedJoinGroupRequestOperationType, message?: string) => Promise<void>;
}
